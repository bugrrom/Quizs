...
export function fetchQuizes() {
    return async dispatch => {
        ...
        try {
            const response = await axios.get('https://react-quiz-bc79e.firebaseio.com/quizes.json');
            const quizes = [];
...
export function fetchQuizById(quizId) {
    return async dispatch => {
        ...
        try {
            const response = await axios.get(`https://react-quiz-bc79e.firebaseio.com/quizes/${quizId}.json`);
